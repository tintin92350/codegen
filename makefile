...
codegen-cli: main.o cli.o ihc.o utils_string_array.o utils_string.o ihc_argument_rule.o
	gcc -o $(EXE_OUTPUT_DIR)/codegen-cli $(OBJ_OUTPUT_DIR)/main.o $(OBJ_OUTPUT_DIR)/cli.o $(OBJ_OUTPUT_DIR)/ihc.o  $(OBJ_OUTPUT_DIR)/utils_string_array.o $(OBJ_OUTPUT_DIR)/utils_string.o $(OBJ_OUTPUT_DIR)/ihc_argument_rule.o -ljansson -std=c17 -Wall -Wextra
