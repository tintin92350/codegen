...
codegen-cli: main.o cli.o ihc.o utils_string_array.o utils_string.o ihc_argument_rule.o ihc_command.o
	gcc -o $(EXE_OUTPUT_DIR)/codegen-cli $(OBJ_OUTPUT_DIR)/main.o $(OBJ_OUTPUT_DIR)/cli.o $(OBJ_OUTPUT_DIR)/ihc.o  $(OBJ_OUTPUT_DIR)/utils_string_array.o $(OBJ_OUTPUT_DIR)/utils_string.o $(OBJ_OUTPUT_DIR)/ihc_argument_rule.o $(OBJ_OUTPUT_DIR)/ihc_command.o -ljansson -std=c17 -Wall -Wextra -g
...
ihc_command.o: src/modules/CLI_IHC/command/command.c
	gcc -c src/modules/CLI_IHC/command/command.c -o $(OBJ_OUTPUT_DIR)/ihc_command.o -std=c17 -Wall -Wextra
